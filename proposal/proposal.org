...
+ Weeks 9-12: Expand the compiler to include lazy and other useful semantics. Also expand tests as needed.
+ Weeks 13-14: If time allows for it, investigate another approach on the project, where the compiler could have been written in HOL.

...
The expression consists of a list of function definitions that each have a
...
are stored in the environment as \texttt{RecClosure}s, each containing
...
is the function \texttt{build\_rec\_env} that creates the \texttt{RecClosure}s.

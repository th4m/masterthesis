...
The evaluation of non-compiled
...
retain the values that their expressions were evaluated to~\cite{pltbook}\todo{Actually not quite sure about this reference. Will confirm soon.}. 
The semantics that

...
category of the grammar that will be implemented. Expressions allow operations \todo{Newly added}
and values to be represented, which is important for a programming language.
This limitation \changed{added the word "limitations"} means that declarations will not be a part of this project.

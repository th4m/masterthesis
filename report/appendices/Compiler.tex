...
This appendix will display the Haskell code for the \texttt{compile} function,
including helper functions used for the implementation. The code shown here is
the post-optimization version of the compiler that has call-by-need semantics.
